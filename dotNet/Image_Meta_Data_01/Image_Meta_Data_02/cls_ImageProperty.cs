    ...
    public class cls_ImageProperty
    {
        ...
        public void CreatePropertyTags()
        {
            Dictionary<int, string> PropertyTags = new Dictionary<int, string>() {
                ...
                { 9, "GPS Status" },
                { 10, "GPS Measure Mode" },
                { 11, "GPS Degree Of Precision" },
                { 12, "GPS Speed Reference" },
                { 13, "GPS Speed" },
                { 14, "GPS True North Reference" },
                { 15, "GPS True North Degrees" },
                { 16, "GPS Image Direction Reference" },
                { 17, "GPS Image Direction" },
                { 18, "GPS Map Datum" },
                { 19, "GPS Destination Latitude Reference" },

                { 20, "GPS Destination Latitude Direction" },
                { 21, "GPS Destination Longitude Reference" },
                { 22, "GPS Destination Longitude Direction" },
                ...
                { 0x0019, "GPS Distance To DestinationReference" },
